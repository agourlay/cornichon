...
import com.github.agourlay.cornichon.dsl.SessionSteps.{ SessionArrayStepBuilder, SessionStepBuilder, SessionValuesStepBuilder }
...
trait CoreDsl {
  ...
  def session_values(key: String): SessionArrayStepBuilder =
    SessionArrayStepBuilder(key)

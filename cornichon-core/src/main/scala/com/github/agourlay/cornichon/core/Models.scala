...
case class FeatureDef(name: String, scenarios: List[Scenario], ignoredBecause: Option[String] = None) {
  require(
...
case class Scenario(name: String, steps: List[Step], ignoredBecause: Option[String] = None)
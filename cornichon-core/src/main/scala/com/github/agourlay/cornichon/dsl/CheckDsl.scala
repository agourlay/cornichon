...
import com.github.agourlay.cornichon.core.{Generator, NoValue, RandomContext, Step}
import com.github.agourlay.cornichon.core.NoValue.seededNoValueGenerator
import com.github.agourlay.cornichon.steps.check.ForAllStep
import com.github.agourlay.cornichon.steps.check.checkModel.{CheckModelStep, ModelRunner}
...
trait CheckDsl {
  ...
  def for_all[A](description: String, maxNumberOfRuns: Int, ga: RandomContext => Generator[A])(builder: A => Step): Step = {
    ...
    ForAllStep[A, NoValue, NoValue, NoValue, NoValue, NoValue](description, maxNumberOfRuns)(
      ga,

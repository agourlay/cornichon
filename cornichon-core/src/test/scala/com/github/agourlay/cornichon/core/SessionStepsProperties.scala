...
class SessionStepsProperties extends Properties("SessionSteps") with CommonTesting {
  ...
  property("sessionStep is value") = forAll { (input: String) =>
  ...
  property("sessionStep hasDifferentCurrentAndPreviousValues") = forAll { (input: String) =>
  ...
  property("sessionStep hasDifferentCurrentAndPreviousValues - failure") = forAll { (input: String) =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
      .addValuesUnsafe(testKey -> input)
    val step = sessionStepBuilder.hasDifferentCurrentAndPreviousValues
  ...
  property("sessionStep hasEqualCurrentAndPreviousValues") = forAll { (input: String) =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
      .addValuesUnsafe(testKey -> input)
  ...
  property("sessionStep hasEqualCurrentAndPreviousValues - failure") = forAll { (input: String) =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
      .addValuesUnsafe(testKey -> (input + "something"))
    val step = sessionStepBuilder.hasEqualCurrentAndPreviousValues
  ...
  property("sessionStep compareWithPreviousValue - equality") = forAll { (input: String) =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
      .addValuesUnsafe(testKey -> input)
  ...
  property("sessionStep compareWithPreviousValue - LessThanAssertion") = forAll { (input: String) =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
      .addValuesUnsafe(testKey -> (input + "something"))
  ...
  property("sessionStep compareWithPreviousValue - LessThanAssertion - failure") = forAll { (input: String) =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
      .addValuesUnsafe(testKey -> input)
    val step = sessionStepBuilder.compareWithPreviousValue { case (prev, current) => LessThanAssertion(prev.length, current.length) }
  ...
  property("sessionStep containsString") = forAll { (input: String) =>
    val session = Session.newEmpty
  ...
  property("sessionStep containsString - failure") = forAll { (input: String) =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
  ...
  property("sessionStep matchesRegex") = forAll(Gen.alphaStr) { input =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> ("prefix" + input + "suffix"))
  ...
  property("sessionStep matchesRegex - failure") = forAll(Gen.alphaStr) { input =>
    val session = Session.newEmpty
      .addValuesUnsafe(testKey -> input)
